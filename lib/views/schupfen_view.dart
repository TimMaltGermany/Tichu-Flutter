...
class SchupfenView extends Component with HasGameRef<TichuGame> {
  ...
  void onGameResize(Vector2 gameSize) {
    ...
    buttonSchupfen.position = Vector2(gameRef.size.x - buttonSchupfen.width,
  ...
  Tuple2<CardState, Offset> determineCardStateFromPosition(Card card,
    ...
    Tuple2<CardState, Offset> returnValue = const Tuple2(CardState.ON_HAND, Offset(0, 0));
